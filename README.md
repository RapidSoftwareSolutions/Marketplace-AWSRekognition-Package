...
| sourceImageBytes    | Blob       | Base64-encoded binary data
...
| targetImageBytes    | Blob       | Base64-encoded binary data
...
| imageBytes    | Blob       | Base64-encoded binary data.
